...
dump_general_name_string_after_srd='*'+str(no_timesteps)+'*after*.h5'
dump_general_name_string_before_srd='*'+str(no_timesteps)+'*before*.h5'
dump_general_name_string_after_pol='*'+str(no_timesteps)+'*after*.h5'
dump_general_name_string_before_pol='*'+str(no_timesteps)+'*before*.h5'
            ...
            with h5.File(realisation_name_h5_after_pol,'r') as f_c:
                with h5.file(realisation_name_h5_before_pol,'r') as f_d:
                    ...
                    for j in range(1,shape_after[0]):
                            ...
                            # taking the position and vel data out of hdf5 format for SRDs
                            ...
                            pol_positions_initial= f_d['particles']['pol']['position']['value'][j-1]
                            pol_positions_after= f_c['particles']['pol']['position']['value'][j]
                            pol_velocities_initial=f_d['particles']['pol']['velocity']['value'][j-1]
                            pol_velocities_after=f_c['particles']['pol']['velocity']['value'][j]
                            ...
                            stress_tensor_summed_xx=delta_mom_pos_tensor_summed_xx_srd + kinetic_energy_tensor_summed_xx_srd+ delta_mom_pos_tensor_summed_xx_pol + kinetic_energy_tensor_summed_xx_pol #xx
                            stress_tensor_summed_yy=delta_mom_pos_tensor_summed_yy_srd + kinetic_energy_tensor_summed_yy_srd + delta_mom_pos_tensor_summed_yy_pol + kinetic_energy_tensor_summed_yy_pol #yy
                            stress_tensor_summed_zz=delta_mom_pos_tensor_summed_zz_srd + kinetic_energy_tensor_summed_zz_srd + delta_mom_pos_tensor_summed_zz_pol + kinetic_energy_tensor_summed_zz_pol#zz
                            
                            
                            stress_tensor_summed_xz=delta_mom_pos_tensor_summed_xz_srd + kinetic_energy_tensor_summed_xz_srd + (erate[data_set]*delta_t_srd*0.5)*kinetic_energy_tensor_summed_zz_srd +    delta_mom_pos_tensor_summed_xz_pol + kinetic_energy_tensor_summed_xz_pol + (erate[data_set]*delta_t_srd*0.5)*kinetic_energy_tensor_summed_zz_pol#xz
                            stress_tensor_summed_xy=delta_mom_pos_tensor_summed_xy_srd + kinetic_energy_tensor_summed_xy_srd+delta_mom_pos_tensor_summed_xy_pol + kinetic_energy_tensor_summed_xy_pol #xy 
                            stress_tensor_summed_yz=delta_mom_pos_tensor_summed_yz_srd + kinetic_energy_tensor_summed_yz_srd+ delta_mom_pos_tensor_summed_yz_pol + kinetic_energy_tensor_summed_yz_pol #yz
                            stress_tensor_summed_zx=delta_mom_pos_tensor_summed_zx_srd + kinetic_energy_tensor_summed_xz_srd + (erate[data_set]*delta_t_srd*0.5)*kinetic_energy_tensor_summed_xz_srd + delta_mom_pos_tensor_summed_zx_pol + kinetic_energy_tensor_summed_xz_pol + (erate[data_set]*delta_t_srd*0.5)*kinetic_energy_tensor_summed_xz_pol #zx
                            stress_tensor_summed_zy=delta_mom_pos_tensor_summed_zy_srd+ kinetic_energy_tensor_summed_yz_srd + delta_mom_pos_tensor_summed_zy_pol+ kinetic_energy_tensor_summed_yz_pol#zy
                            stress_tensor_summed_yx=delta_mom_pos_tensor_summed_yx_srd + kinetic_energy_tensor_summed_xy_srd+ delta_mom_pos_tensor_summed_yx_pol + kinetic_energy_tensor_summed_xy_pol#yx
