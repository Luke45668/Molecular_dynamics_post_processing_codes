...
dump_general_name_string_after_pol='*gdot_'+str(erate)+'*pol*after*.h5'
dump_general_name_string_before_pol='*gdot_'+str(erate)+'*pol*before*.h5'
dump_general_name_string_after_phantom='*gdot_'+str(erate)+'*phantom*after*.h5'
                ...
                with h5.File(realisation_name_h5_after_phantom,'r') as f_ph:
                    ...
                    for j in range(1,shape_after[0]):
                              ...
                              stress_tensor_summed_zx=(spring_force_positon_tensor_zx + delta_mom_pos_tensor_summed_zx_pol + kinetic_energy_tensor_summed_xz_pol 
                                                       + (erate[data_set]*delta_t_srd*0.5)*kinetic_energy_tensor_summed_zz_pol) #zx
...
if __name__ =='__main__':
        ...
        np.save("area_vector_summed_1d_test_erate_"+str(erate[0])+"_bk_"\
        ...
        np.save("stress_tensor_summed_1d_test_erate_"\
                +str(erate[0])+"_bk_"+str(bending_stiffness)+\
