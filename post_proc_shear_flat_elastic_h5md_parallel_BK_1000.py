...
dump_general_name_string_after_srd='*BK_'+str(bending_stiffness)+'_*SRDs*after*.h5'
dump_general_name_string_before_srd='*BK_'+str(bending_stiffness)+'_*SRDs*before*.h5'
dump_general_name_string_after_pol='*BK_'+str(bending_stiffness)+'_*pol*after*.h5'
dump_general_name_string_before_pol='*BK_'+str(bending_stiffness)+'_*pol*before*.h5'
dump_general_name_string_after_phantom='*BK_'+str(bending_stiffness)+'_*phantom*after*.h5'
dump_general_name_string_before_phantom='*BK_'+str(bending_stiffness)+'_*phantom*before*.h5'
    ...
    with h5.File(realisation_name_h5_after_srd, 'r') as f_a:
        with h5.File(realisation_name_h5_before_srd, 'r') as f_b:
            with h5.File(realisation_name_h5_after_pol,'r') as f_c:
                print(realisation_name_h5_after_pol)
