...
dump_general_name_string_after_pol='*_restartcount_'+str(restart_count)+'_*gdot_'+str(erate)+'_BK_10000_K_'+str(int(internal_stiffness[0]))+'_pol_after_rotation.h5'

dump_general_name_string_before_pol='*_restartcount_'+str(restart_count)+'*gdot_'+str(erate)+'_BK_10000_K_'+str(int(internal_stiffness[0]))+'_pol_before_rotation.h5'

dump_general_name_string_after_phantom='*_restartcount_'+str(restart_count)+'*gdot_'+str(erate)+'_BK_10000_K_'+str(int(internal_stiffness[0]))+'_phantom_after_rotation.h5'
...
def area_vector_calculation(eq_spring_length,
                            ...
                            delta_mom_pos_tensor_summed_shared,
                            kinetic_energy_tensor_summed_shared,
                            spring_pos_tensor_summed_shared,
     ...
     with h5.File(realisation_name_h5_after_pol,'r') as f_c:
          with h5.File(realisation_name_h5_before_pol,'r') as f_d:
                with h5.File(realisation_name_h5_after_phantom,'r') as f_ph:
                    ...
                    # spring constant 
                    K=internal_stiffness[int(np.where(internal_stiffness==float(realisation_name_h5_after_pol.split('_')[20]))[0][0])]
                    ...
                    for j in range(1,shape_after[0]):
                              ...
                              np_array_delta_mom_pos_tensor=np.array([delta_mom_pos_tensor_summed_xx_pol,
                                                                      delta_mom_pos_tensor_summed_yy_pol,
                                                                      delta_mom_pos_tensor_summed_zz_pol,
                                                                      delta_mom_pos_tensor_summed_xz_pol,
                                                                      delta_mom_pos_tensor_summed_xy_pol,
                                                                      delta_mom_pos_tensor_summed_yz_pol,
                                                                      delta_mom_pos_tensor_summed_zx_pol,
                                                                      delta_mom_pos_tensor_summed_zy_pol,
                                                                      delta_mom_pos_tensor_summed_yx_pol])

                              np_array_ke_tensor=np.array([kinetic_energy_tensor_summed_xx_pol,
                                                            kinetic_energy_tensor_summed_yy_pol,
                                                            kinetic_energy_tensor_summed_zz_pol,
                                                            kinetic_energy_tensor_summed_xy_pol,
                                                            kinetic_energy_tensor_summed_xz_pol,
                                                            kinetic_energy_tensor_summed_yz_pol,])
                              ...
                              start_index_6_element=terms_6[j+(count)-1] # has -1 when there is more than one set 
                              ...
                              kinetic_energy_tensor_summed_shared[start_index_6_element:end_index_6_element]=np_array_ke_tensor
                              delta_mom_pos_tensor_summed_shared[start_index_9_element:end_index_9_element]= np_array_delta_mom_pos_tensor
                              spring_pos_tensor_summed_shared[start_index_9_element:end_index_9_element]=np_array_spring_pos_tensor
                             

                              stress_tensor_summed_shared[start_index_9_element:end_index_9_element]=np_array_stress_tensor


     return area_vector_summed_shared,stress_tensor_summed_shared,kinetic_energy_tensor_summed_shared, delta_mom_pos_tensor_summed_shared,spring_pos_tensor_summed_shared


# parallel analysis of small run 
# determine size of 1-d array
size_area_vector_summed=int(no_data_sets*j_*((shape_after[0]-1))*3) 
size_ke_tensor_summed=int(no_data_sets*j_*((shape_after[0]-1))*6) 
...
if __name__ =='__main__':
        ...
        delta_mom_pos_tensor_summed_shared=mp.Array('d',range(size_stress_tensor_summed))
        kinetic_energy_tensor_summed_shared=mp.Array('d',range(size_ke_tensor_summed))
        spring_pos_tensor_summed_shared=mp.Array('d',range(size_stress_tensor_summed))
        ...
        np.save("delta_mom_pos_tensor_summed_1d_test_restartcount_"+str(restart_count)+"_erate_"+str(erate)+"_bk_"\
                +str(bending_stiffness)+"_K_"+str(internal_stiffness[0])+\
                "_"+str(internal_stiffness[-1])+"_L_"+str(box_size)+\
                "_no_timesteps_"+str(no_timesteps),delta_mom_pos_tensor_summed_shared)
        np.save("kinetic_energy_tensor_summed_1d_test_restartcount_"+str(restart_count)+"_erate_"+str(erate)+"_bk_"\
                +str(bending_stiffness)+"_K_"+str(internal_stiffness[0])+\
                "_"+str(internal_stiffness[-1])+"_L_"+str(box_size)+\
                "_no_timesteps_"+str(no_timesteps), kinetic_energy_tensor_summed_shared)
        np.save("spring_pos_tensor_summed_1d_test_restartcount_"+str(restart_count)+"_erate_"+str(erate)+"_bk_"\
                +str(bending_stiffness)+"_K_"+str(internal_stiffness[0])+\
                "_"+str(internal_stiffness[-1])+"_L_"+str(box_size)+\
                "_no_timesteps_"+str(no_timesteps),  spring_pos_tensor_summed_shared)
