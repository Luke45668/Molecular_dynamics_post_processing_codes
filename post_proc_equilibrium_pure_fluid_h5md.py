...
for k in range(0,j_):
    for j in range(1,shape_after[0]-1):
        with h5.File(realisation_name_h5_after[k], 'r') as f_a:
                ...
                stress_tensor_summed[k,j,3]=delta_mom_pos_tensor_summed[k,j,3] + kinetic_energy_tensor_summed[k,j,4]#xz
                ...
                stress_tensor_summed[k,j,6]=delta_mom_pos_tensor_summed[k,j,6] + kinetic_energy_tensor_summed[k,j,4]#zx
