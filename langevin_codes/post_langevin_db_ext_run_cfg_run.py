...
for i in range(100):
    ...
    full_dump_coord_before[i]=cfg2numpy_coords(Path_2_dump,realisation_name_before_sorted_final_cfg[i],
                      n_plates*2, 4)
    sort_array=full_dump_coord_before[i]
    full_dump_coord_before[i] = sort_array[sort_array[:,3].argsort()]
    full_dump_coord_after[i]=cfg2numpy_coords(Path_2_dump,realisation_name_after_sorted_final_cfg[i],
                      n_plates*2, 4)
