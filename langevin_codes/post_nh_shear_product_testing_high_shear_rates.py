...
path_2_log_files="/Users/luke_dev/Documents/MYRIAD_lammps_runs/nvt_runs/shear_runs/strain_250_8_reals_erate_over_1.34/"
...
for j in range(0,K.size):
    ...
    xz_stress_std=stress_tensor_std_tuple[j][cutoff:,3]/np.sqrt(j_)
    #powerlaw
