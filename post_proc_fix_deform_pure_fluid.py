...
realisation_name = "log.testout_no806324_wall_pure_output_no_rescale_541709_2_60835_23.0_0.005071624521210362_10_10000_10000_3000000_T_1_lbda_0.05071624521210362_gdot_0" # with shear 
...
dump_realisation_name_before= "testout_541709_2_60835_23.0_0.005071624521210362_10_gdot_0_10000_3000000_after_rotation.dump"
dump_file_before= dump2numpy_f(dump_start_line,Path_2_dump,dump_realisation_name_before,number_of_particles_per_dump)
dump_realisation_name_after= "testout_541709_2_60835_23.0_0.005071624521210362_10_gdot_0_10000_3000000_before_rotation.dump"
...
for i in range(0,loop_size):
    for j in range(0,number_of_particles_per_dump):
        ...
        id= int(float(dump_file_shaped_after[i,j,0]))-1
        dump_file_sorted_after[i,id,:]= dump_file_shaped_after[i,j,:]
...
delta_mom_pos_tensor_from_dump_partial_sum = np.zeros((99,4))
...
for i in range(0,3):
    plt.plot(delta_mom_pos_tensor_from_dump_partial_sum[:,i])
